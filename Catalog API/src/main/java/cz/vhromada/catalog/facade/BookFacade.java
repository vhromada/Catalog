...
public interface BookFacade {
     ...
     * @throws cz.vhromada.validators.exceptions.RecordNotFoundException      if TO for book category doesn't exist in data storage
     * @throws cz.vhromada.catalog.facade.exceptions.FacadeOperationException if there was error in working with service tier
     */
     ...
     *                                                                        or TO for book category is null
     *                                                                        or TO for book category ID is null
     * @throws cz.vhromada.validators.exceptions.RecordNotFoundException      if TO for book doesn't exist in data storage

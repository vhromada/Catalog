...
//            DeepAsserts.assertEquals(EntitiesUtils.getSong(musicNumber, songNumber), songService.getSong(i + 1));
//        }
...
//            final int musicNumber = i / SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            final int songNumber = i % SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            SpringUtils.assertCacheValue(musicCache, keys.get(i), EntitiesUtils.getSong(musicNumber, songNumber));
//        }
//    }
//
//    /**
...
//        final Song song = EntitiesUtils.newSong(objectGenerator, entityManager);
//
...
//        final Song song = EntitiesUtils.updateSong(1, objectGenerator, entityManager);
//
...
//        final Song expectedSong = EntitiesUtils.getSong(1, 3);
...
//            final int musicNumber = i / SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            final int songNumber = i % SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            DeepAsserts.assertEquals(EntitiesUtils.getSong(musicNumber, songNumber), SpringUtils.getSong(entityManager, i + 1));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SONGS_COUNT + 1, SpringUtils.getSongsCount(entityManager));
//        DeepAsserts.assertEquals(0, SpringUtils.getCacheKeys(musicCache).size());
//    }
...
//        final Song expectedSong1 = EntitiesUtils.getSong(1, 1);
//        expectedSong1.setPosition(1);
//        final Song expectedSong2 = EntitiesUtils.getSong(1, 2);
...
//            final int musicNumber = i / SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            final int songNumber = i % SpringUtils.SONGS_PER_MUSIC_COUNT + 1;
//            assertTrue(songService.exists(EntitiesUtils.getSong(musicNumber, songNumber)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SONGS_COUNT, SpringUtils.getSongsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(musicCache));
//        for (int i = 0; i < SpringUtils.SONGS_COUNT; i++) {
...
//            DeepAsserts.assertEquals(EntitiesUtils.getSongs(i), songService.findSongsByMusic(music));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SONGS_COUNT, SpringUtils.getSongsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(musicCache));
//        for (int i = 0; i < SpringUtils.MUSIC_COUNT; i++) {
//            SpringUtils.assertCacheValue(musicCache, keys.get(i), EntitiesUtils.getSongs(i + 1));
//        }
//    }
//
//    /**

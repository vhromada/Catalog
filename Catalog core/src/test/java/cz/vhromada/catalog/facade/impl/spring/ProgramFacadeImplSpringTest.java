...
//        for (final Program program : EntitiesUtils.getPrograms()) {
//            program.setId(null);
...
//        final Program program = EntitiesUtils.getProgram(SpringUtils.PROGRAMS_COUNT);
...
//        final Program program1 = EntitiesUtils.getProgram(1);
//        program1.setPosition(1);
//        final Program program2 = EntitiesUtils.getProgram(2);

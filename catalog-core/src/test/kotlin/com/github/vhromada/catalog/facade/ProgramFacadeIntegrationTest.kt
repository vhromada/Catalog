...
class ProgramFacadeIntegrationTest : MovableParentFacadeIntegrationTest<Program, com.github.vhromada.catalog.domain.Program>() {
    ...
    override fun getDataList(): List<com.github.vhromada.catalog.domain.Program> {
        return ProgramUtils.getPrograms()
    }

    override fun getDomainData(index: Int): com.github.vhromada.catalog.domain.Program {
    ...
    override fun newDomainData(id: Int): com.github.vhromada.catalog.domain.Program {
        return ProgramUtils.newProgramDomain(id)
    }

    override fun getRepositoryData(id: Int): com.github.vhromada.catalog.domain.Program? {
    ...
    override fun assertDataListDeepEquals(expected: List<Program>, actual: List<com.github.vhromada.catalog.domain.Program>) {
        ProgramUtils.assertProgramListDeepEquals(expected, actual)
    }

    override fun assertDataDeepEquals(expected: Program, actual: com.github.vhromada.catalog.domain.Program) {
        ProgramUtils.assertProgramDeepEquals(expected, actual)
    }

    override fun assertDataDomainDeepEquals(expected: com.github.vhromada.catalog.domain.Program, actual: com.github.vhromada.catalog.domain.Program) {
        ProgramUtils.assertProgramDeepEquals(expected, actual)
    }

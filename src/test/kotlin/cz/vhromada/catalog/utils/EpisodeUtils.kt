...
object EpisodeUtils {
     ...
     */
    fun getEpisodes(show: Int, season: Int): List<cz.vhromada.catalog.domain.Episode> {
     ...
     */
    fun getEpisode(index: Int): cz.vhromada.catalog.domain.Episode {
     ...
     */
    private fun getEpisode(showIndex: Int, seasonIndex: Int, episodeIndex: Int): cz.vhromada.catalog.domain.Episode {
     ...
     * @return episode
     */
    fun getEpisode(entityManager: EntityManager, id: Int): cz.vhromada.catalog.domain.Episode? {
        return entityManager.find(cz.vhromada.catalog.domain.Episode::class.java, id)
    }
     ...
     */
    fun assertEpisodesDeepEquals(expected: List<cz.vhromada.catalog.domain.Episode?>?, actual: List<cz.vhromada.catalog.domain.Episode?>?) {
        assertSoftly {
     ...
     */
    fun assertEpisodeDeepEquals(expected: cz.vhromada.catalog.domain.Episode?, actual: cz.vhromada.catalog.domain.Episode?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual episodes
     */
    fun assertEpisodeListDeepEquals(expected: List<Episode?>?, actual: List<cz.vhromada.catalog.domain.Episode?>?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual episode
     */
    fun assertEpisodeDeepEquals(expected: Episode?, actual: cz.vhromada.catalog.domain.Episode?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }

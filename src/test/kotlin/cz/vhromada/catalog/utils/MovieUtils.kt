 ...
 */
fun cz.vhromada.catalog.domain.Movie.updated(): cz.vhromada.catalog.domain.Movie {
    return copy(
            czechName = "czName",
...
object MovieUtils {
     ...
     * @return movies
     */
    fun getMovies(): List<cz.vhromada.catalog.domain.Movie> {
        val movies = ArrayList<cz.vhromada.catalog.domain.Movie>()
     ...
     * @return movie
     */
    fun newMovieDomain(id: Int?): cz.vhromada.catalog.domain.Movie {
     ...
     */
    fun getMovie(index: Int): cz.vhromada.catalog.domain.Movie {
     ...
     * @return movie
     */
    fun getMovie(entityManager: EntityManager, id: Int): cz.vhromada.catalog.domain.Movie? {
        return entityManager.find(cz.vhromada.catalog.domain.Movie::class.java, id)
    }
     ...
     */
    fun updateMovie(entityManager: EntityManager, id: Int): cz.vhromada.catalog.domain.Movie {
     ...
     */
    fun assertMoviesDeepEquals(expected: List<cz.vhromada.catalog.domain.Movie?>?, actual: List<cz.vhromada.catalog.domain.Movie?>?) {
        assertSoftly {
     ...
     */
    fun assertMovieDeepEquals(expected: cz.vhromada.catalog.domain.Movie?, actual: cz.vhromada.catalog.domain.Movie?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual movies
     */
    fun assertMovieListDeepEquals(expected: List<Movie?>?, actual: List<cz.vhromada.catalog.domain.Movie?>?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }
     ...
     * @param actual   actual movie
     */
    fun assertMovieDeepEquals(expected: Movie?, actual: cz.vhromada.catalog.domain.Movie?) {
        assertSoftly {
            it.assertThat(expected).isNotNull
            it.assertThat(actual).isNotNull
        }

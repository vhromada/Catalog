...
class GameValidatorTest extends MovableValidatorTest<Game, cz.vhromada.catalog.domain.Game> {
    ...
    void validate_Deep_NullName() {
        ...
        final Result<Void> result = getValidator().validate(game, ValidationType.DEEP);
    ...
    @Override
    protected MovableValidator<Game> getValidator() {
        return new GameValidator(getService());
    }

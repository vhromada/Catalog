...
/**
 * A class represents test for converter from {@link BookTO} to {@link Book}.
 *
...
public class BookTOToBookConverterTest {
    ...
    public void testConvert() {
        ...
        final Book book = converter.convert(bookTO, Book.class);
        DeepAsserts.assertNotNull(book);
        DeepAsserts.assertEquals(bookTO, book);
    }
    ...
    public void testConvertWithNullArgument() {
        assertNull(converter.convert(null, Book.class));
    }

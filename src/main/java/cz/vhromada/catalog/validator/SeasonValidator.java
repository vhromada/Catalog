...
public class SeasonValidator extends AbstractMovableValidator<Season, Show> {

    /**
     * Creates a new instance of SeasonValidator.
     *
     * @param showService service for shows
     * @throws IllegalArgumentException if service for shows is null
     */
    @Autowired
    public SeasonValidator(final MovableService<Show> showService) {

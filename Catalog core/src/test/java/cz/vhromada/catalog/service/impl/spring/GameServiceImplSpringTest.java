...
//        final List<Game> games = EntitiesUtils.getGames();
...
//
//        for (int i = 1; i <= SpringUtils.GAMES_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getGame(i), gameService.getGame(i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.GAMES_COUNT, SpringUtils.getGamesCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(gameCache));
//        for (int i = 1; i <= SpringUtils.GAMES_COUNT; i++) {
//            SpringUtils.assertCacheValue(gameCache, keys.get(i - 1), EntitiesUtils.getGame(i));
//        }
//    }
//
//    /**
...
//        final Game game = EntitiesUtils.newGame(objectGenerator);
//
...
//        final Game game = EntitiesUtils.updateGame(1, objectGenerator, entityManager);
//
...
//        final Game expectedGame = EntitiesUtils.getGame(3);
...
//        for (int i = 1; i <= SpringUtils.GAMES_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getGame(i), SpringUtils.getGame(entityManager, i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.GAMES_COUNT + 1, SpringUtils.getGamesCount(entityManager));
//        DeepAsserts.assertEquals(0, SpringUtils.getCacheKeys(gameCache).size());
//    }
...
//        final Game expectedGame1 = EntitiesUtils.getGame(1);
//        expectedGame1.setPosition(1);
//        final Game expectedGame2 = EntitiesUtils.getGame(2);
...
//
//        for (int i = 1; i <= SpringUtils.GAMES_COUNT; i++) {
//            assertTrue(gameService.exists(EntitiesUtils.getGame(i)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.GAMES_COUNT, SpringUtils.getGamesCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(gameCache));
//        for (int i = 1; i <= SpringUtils.GAMES_COUNT; i++) {
...
//        DeepAsserts.assertEquals(SpringUtils.GAMES_COUNT, SpringUtils.getGamesCount(entityManager));
//        DeepAsserts.assertEquals(CollectionUtils.newList(key), SpringUtils.getCacheKeys(gameCache));
//        SpringUtils.assertCacheValue(gameCache, key, EntitiesUtils.getGames());
//    }
//
//}

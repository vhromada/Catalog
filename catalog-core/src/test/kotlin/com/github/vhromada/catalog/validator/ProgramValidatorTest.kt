 ...
 */
class ProgramValidatorTest : MovableValidatorTest<Program, com.github.vhromada.catalog.domain.Program>() {
    ...
    override fun getRepositoryData(validatingData: Program): com.github.vhromada.catalog.domain.Program {
        return ProgramUtils.newProgramDomain(validatingData.id)
    }

    override fun getItem1(): com.github.vhromada.catalog.domain.Program {
        return ProgramUtils.newProgramDomain(1)
    }

    override fun getItem2(): com.github.vhromada.catalog.domain.Program {

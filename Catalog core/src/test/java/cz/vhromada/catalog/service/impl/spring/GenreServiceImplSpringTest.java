...
//        final List<Genre> genres = EntitiesUtils.getGenres();
...
//
//        for (int i = 1; i <= SpringUtils.GENRES_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getGenre(i), genreService.getGenre(i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.GENRES_COUNT, SpringUtils.getGenresCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(genreCache));
//        for (int i = 1; i <= SpringUtils.GENRES_COUNT; i++) {
//            SpringUtils.assertCacheValue(genreCache, keys.get(i - 1), EntitiesUtils.getGenre(i));
//        }
//    }
//
//    /**
...
//        final Genre genre = EntitiesUtils.newGenre(objectGenerator);
//
...
//        final Genre genre = EntitiesUtils.updateGenre(1, objectGenerator, entityManager);
//
...
//
//        for (int i = 1; i <= SpringUtils.GENRES_COUNT; i++) {
//            assertTrue(genreService.exists(EntitiesUtils.getGenre(i)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.GENRES_COUNT, SpringUtils.getGenresCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(genreCache));
//        for (int i = 1; i <= SpringUtils.GENRES_COUNT; i++) {

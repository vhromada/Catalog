...
//            DeepAsserts.assertEquals(EntitiesUtils.getSeason(showNumber, seasonNumber), seasonService.getSeason(i + 1));
//        }
...
//            final int showNumber = i / SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            final int seasonNumber = i % SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            SpringUtils.assertCacheValue(showCache, keys.get(i), EntitiesUtils.getSeason(showNumber, seasonNumber));
//        }
//    }
//
//    /**
...
//        final Season expectedSeason = EntitiesUtils.getSeason(1, 3);
...
//            final int showNumber = i / SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            final int seasonNumber = i % SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            DeepAsserts.assertEquals(EntitiesUtils.getSeason(showNumber, seasonNumber), SpringUtils.getSeason(entityManager, i + 1));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SEASONS_COUNT + 1, SpringUtils.getSeasonsCount(entityManager));
//        DeepAsserts.assertEquals(0, SpringUtils.getCacheKeys(showCache).size());
//    }
...
//        final Season expectedSeason1 = EntitiesUtils.getSeason(1, 1);
//        expectedSeason1.setPosition(1);
//        final Season expectedSeason2 = EntitiesUtils.getSeason(1, 2);
...
//            final int showNumber = i / SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            final int seasonNumber = i % SpringUtils.SEASONS_PER_SHOW_COUNT + 1;
//            assertTrue(seasonService.exists(EntitiesUtils.getSeason(showNumber, seasonNumber)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SEASONS_COUNT, SpringUtils.getSeasonsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(showCache));
//        for (int i = 0; i < SpringUtils.SEASONS_COUNT; i++) {
...
//            DeepAsserts.assertEquals(EntitiesUtils.getSeasons(i), seasonService.findSeasonsByShow(show));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SEASONS_COUNT, SpringUtils.getSeasonsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(showCache));
//        for (int i = 0; i < SpringUtils.SHOWS_COUNT; i++) {
//            SpringUtils.assertCacheValue(showCache, keys.get(i), EntitiesUtils.getSeasons(i + 1));
//        }
//    }
//
//}

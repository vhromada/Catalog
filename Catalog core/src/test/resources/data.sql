...
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES (1, 'Movie 1 czech name', 'Movie 1 original name', 2001, 'CZ', 'Movie 1 CSFD', 1, 'Movie 1 English Wikipedia', 'Movie 1 Czech Wikipedia', 'Movie 1 pc', '', 0);
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES (2, 'Movie 2 czech name', 'Movie 2 original name', 2002, 'JP', 'Movie 2 CSFD', 2, 'Movie 2 English Wikipedia', 'Movie 2 Czech Wikipedia', 'Movie 2 pc', '', 1);
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES (3, 'Movie 3 czech name', 'Movie 3 original name', 2003, 'FR', 'Movie 3 CSFD', 3, 'Movie 3 English Wikipedia', 'Movie 3 Czech Wikipedia', 'Movie 3 pc', 'Movie 3 note', 2);

 ...
 */
class GameValidatorImplTest extends AbstractValidatorTest<Game, cz.vhromada.catalog.domain.Game> {

    /**
     * Test method for {@link GameValidatorImpl#GameValidatorImpl(CatalogService)} with null service for games.
     */
    @Test

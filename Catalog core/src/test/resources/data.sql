INSERT INTO genres (id, genre_name) VALUES (1, 'Genre 1 name');
INSERT INTO genres (id, genre_name) VALUES (2, 'Genre 2 name');
INSERT INTO genres (id, genre_name) VALUES (3, 'Genre 3 name');
INSERT INTO genres (id, genre_name) VALUES (4, 'Genre 4 name');
...
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES
  (1, 'Movie 1 czech name', 'Movie 1 original name', 2001, 'CZ', 'Movie 1 CSFD', 1, 'Movie 1 English Wikipedia', 'Movie 1 Czech Wikipedia', 'Movie 1 pc', '',
   0);
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES
  (2, 'Movie 2 czech name', 'Movie 2 original name', 2002, 'JP', 'Movie 2 CSFD', 2, 'Movie 2 English Wikipedia', 'Movie 2 Czech Wikipedia', 'Movie 2 pc', '',
   1);
INSERT INTO movies (id, czech_name, original_name, movie_year, movie_language, csfd, imdb_code, wiki_en, wiki_cz, picture, note, position) VALUES
  (3, 'Movie 3 czech name', 'Movie 3 original name', 2003, 'FR', 'Movie 3 CSFD', 3, 'Movie 3 English Wikipedia', 'Movie 3 Czech Wikipedia', 'Movie 3 pc',
   'Movie 3 note', 2);
...
VALUES (1, 'Music 1 name', 'Music 1 English Wikipedia', 'Music 1 Czech Wikipedia', 10, '', 0);
INSERT INTO music (id, music_name, wiki_en, wiki_cz, media_count, note, position)
VALUES (2, 'Music 2 name', 'Music 2 English Wikipedia', 'Music 2 Czech Wikipedia', 20, 'Music 2 note', 1);
INSERT INTO music (id, music_name, wiki_en, wiki_cz, media_count, note, position)
VALUES (3, 'Music 3 name', 'Music 3 English Wikipedia', 'Music 3 Czech Wikipedia', 30, '', 2);
...
INSERT INTO programs (id, program_name, wiki_en, wiki_cz, media_count, crack, serial_key, other_data, note, position)
VALUES (1, 'Program 1 name', 'Program 1 English Wikipedia', 'Program 1 Czech Wikipedia', 100, FALSE, FALSE, '', '', 0);
INSERT INTO programs (id, program_name, wiki_en, wiki_cz, media_count, crack, serial_key, other_data, note, position)
VALUES (2, 'Program 2 name', 'Program 2 English Wikipedia', 'Program 2 Czech Wikipedia', 200, FALSE, TRUE, '', '', 1);
INSERT INTO programs (id, program_name, wiki_en, wiki_cz, media_count, crack, serial_key, other_data, note, position)
VALUES (3, 'Program 3 name', 'Program 3 English Wikipedia', 'Program 3 Czech Wikipedia', 300, TRUE, TRUE, 'Program 3 other data', 'Program 3 note', 2);
...
INSERT INTO book_languages (book, book_language) VALUES (3, 'FR');
INSERT INTO book_languages (book, book_language) VALUES (4, 'CZ');
INSERT INTO book_languages (book, book_language) VALUES (5, 'EN');
INSERT INTO book_languages (book, book_language) VALUES (5, 'JP');
INSERT INTO book_languages (book, book_language) VALUES (6, 'FR');
INSERT INTO book_languages (book, book_language) VALUES (7, 'CZ');
INSERT INTO book_languages (book, book_language) VALUES (8, 'EN');
INSERT INTO book_languages (book, book_language) VALUES (8, 'JP');
INSERT INTO book_languages (book, book_language) VALUES (9, 'FR');
...
ALTER SEQUENCE book_categories_sq RESTART WITH 4;
ALTER SEQUENCE books_sq RESTART WITH 10;

...
//
///**
// * A class represents test for class {@link cz.vhromada.catalog.service.impl.MovieServiceImpl} with Spring framework.
// *
...
//        final List<Movie> movies = EntitiesUtils.getMovies();
...
//
//        for (int i = 1; i <= SpringUtils.MOVIES_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getMovie(i), movieService.getMovie(i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.MOVIES_COUNT, SpringUtils.getMoviesCount(entityManager));
//        DeepAsserts.assertEquals(SpringUtils.MEDIA_COUNT, SpringUtils.getMediaCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(movieCache));
//        for (int i = 1; i <= SpringUtils.MOVIES_COUNT; i++) {
//            SpringUtils.assertCacheValue(movieCache, keys.get(i - 1), EntitiesUtils.getMovie(i));
//        }
//    }
//
//    /**
...
//        final Movie movie = EntitiesUtils.newMovie(objectGenerator, entityManager);
//
...
//        final Movie movie = EntitiesUtils.updateMovie(1, objectGenerator, entityManager);
//
...
//        final Movie expectedMovie = EntitiesUtils.getMovie(3);
...
//        for (int i = 1; i <= SpringUtils.MOVIES_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getMovie(i), SpringUtils.getMovie(entityManager, i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.MOVIES_COUNT + 1, SpringUtils.getMoviesCount(entityManager));
...
//        final Movie expectedMovie1 = EntitiesUtils.getMovie(1);
//        expectedMovie1.setPosition(1);
//        final Movie expectedMovie2 = EntitiesUtils.getMovie(2);
...
//
//        for (int i = 1; i <= SpringUtils.MOVIES_COUNT; i++) {
//            assertTrue(movieService.exists(EntitiesUtils.getMovie(i)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.MOVIES_COUNT, SpringUtils.getMoviesCount(entityManager));
//        DeepAsserts.assertEquals(SpringUtils.MEDIA_COUNT, SpringUtils.getMediaCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(movieCache));
...
//        DeepAsserts.assertEquals(SpringUtils.MEDIA_COUNT, SpringUtils.getMediaCount(entityManager));
//        DeepAsserts.assertEquals(CollectionUtils.newList(key), SpringUtils.getCacheKeys(movieCache));
//        SpringUtils.assertCacheValue(movieCache, key, EntitiesUtils.getMovies());
//    }
//
//    /**

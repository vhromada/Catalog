...
//        for (final Movie movie : EntitiesUtils.getMovies()) {
//            movie.setId(null);
...
//        final Movie movie = EntitiesUtils.getMovie(SpringUtils.MOVIES_COUNT);
...
//        final Movie movie1 = EntitiesUtils.getMovie(1);
//        movie1.setPosition(1);
//        final Movie movie2 = EntitiesUtils.getMovie(2);

...
public class GameServiceImpl extends AbstractService<Game> implements GameService {
    ...
    public void duplicate(final Game game) {
        ...
        try {
            ...
            newGame.setCrack(game.getCrack());
            newGame.setSerialKey(game.getSerialKey());
            newGame.setPatch(game.getPatch());
            newGame.setTrainer(game.getTrainer());
            newGame.setTrainerData(game.getTrainerData());
            newGame.setEditor(game.getEditor());
            newGame.setSaves(game.getSaves());

...
//        for (final Game game : EntitiesUtils.getGames()) {
//            game.setId(null);
...
//        final Game game = EntitiesUtils.getGame(SpringUtils.GAMES_COUNT);
...
//        final Game game1 = EntitiesUtils.getGame(1);
//        game1.setPosition(1);
//        final Game game2 = EntitiesUtils.getGame(2);
//        game2.setPosition(0);
//

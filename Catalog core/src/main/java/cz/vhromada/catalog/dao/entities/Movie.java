...
@Entity
@Table(name = "movies")
@NamedQuery(name = Movie.SELECT_MOVIES, query = "SELECT m FROM Movie m ORDER BY position, id")
public class Movie implements Serializable {
	...
	public String toString() {
		return String.format("Movie [id=%d, czechName=%s, originalName=%s, year=%d, language=%s, subtitles=%s, media=%s, csfd=%s, imdbCode=%d, wikiEn=%s, "
				+ "wikiCz=%s, picture=%s, note=%s, position=%d, genres=%s]", id, czechName, originalName, year, language, subtitles, media, csfd, imdbCode,

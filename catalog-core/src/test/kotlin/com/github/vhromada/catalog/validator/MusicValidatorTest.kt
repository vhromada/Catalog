 ...
 */
class MusicValidatorTest : MovableValidatorTest<Music, com.github.vhromada.catalog.domain.Music>() {
    ...
    override fun getRepositoryData(validatingData: Music): com.github.vhromada.catalog.domain.Music {
        return MusicUtils.newMusicDomain(validatingData.id)
    }

    override fun getItem1(): com.github.vhromada.catalog.domain.Music {
        return MusicUtils.newMusicDomain(1)
    }

    override fun getItem2(): com.github.vhromada.catalog.domain.Music {

...
//        final List<Show> shows = EntitiesUtils.getShows();
...
//
//        for (int i = 1; i <= SpringUtils.SHOWS_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getShow(i), showService.getShow(i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SHOWS_COUNT, SpringUtils.getShowsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(showCache));
//        for (int i = 1; i <= SpringUtils.SHOWS_COUNT; i++) {
//            SpringUtils.assertCacheValue(showCache, keys.get(i - 1), EntitiesUtils.getShow(i));
//        }
//    }
//
//    /**
...
//        final Show expectedShow = EntitiesUtils.getShow(3);
...
//        for (int i = 1; i <= SpringUtils.SHOWS_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getShow(i), SpringUtils.getShow(entityManager, i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SHOWS_COUNT + 1, SpringUtils.getShowsCount(entityManager));
//        DeepAsserts.assertEquals(0, SpringUtils.getCacheKeys(showCache).size());
//    }
...
//        final Show expectedShow1 = EntitiesUtils.getShow(1);
//        expectedShow1.setPosition(1);
//        final Show expectedShow2 = EntitiesUtils.getShow(2);
...
//
//        for (int i = 1; i <= SpringUtils.SHOWS_COUNT; i++) {
//            assertTrue(showService.exists(EntitiesUtils.getShow(i)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.SHOWS_COUNT, SpringUtils.getShowsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(showCache));
//        for (int i = 1; i <= SpringUtils.SHOWS_COUNT; i++) {
...
//        DeepAsserts.assertEquals(SpringUtils.SHOWS_COUNT, SpringUtils.getShowsCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(showCache));
//        SpringUtils.assertCacheValue(showCache, keyList, EntitiesUtils.getShows());
//        for (int i = 1; i <= seasonsCount; i++) {
//            SpringUtils.assertCacheValue(showCache, seasonKeyItems.get(i - 1), EntitiesUtils.getSeasons(i));
//        }
...
//            SpringUtils.assertCacheValue(showCache, episodeKeyItems.get(i), EntitiesUtils.getEpisodes(showNumber, seasonNumber));
//        }
//    }
//
//    /**
...
//        SpringUtils.assertCacheValue(showCache, keyList, EntitiesUtils.getShows());
//        for (int i = 1; i <= count; i++) {
//            SpringUtils.assertCacheValue(showCache, keyItems.get(i - 1), EntitiesUtils.getSeasons(i));
//        }
//    }
//
//    /**

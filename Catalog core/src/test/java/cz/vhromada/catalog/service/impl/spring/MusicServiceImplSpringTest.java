...
//        final List<Music> music = EntitiesUtils.getMusic();
...
//
//        for (int i = 1; i <= SpringUtils.MUSIC_COUNT; i++) {
//            DeepAsserts.assertEquals(EntitiesUtils.getMusic(i), musicService.getMusic(i));
//        }
//        DeepAsserts.assertEquals(SpringUtils.MUSIC_COUNT, SpringUtils.getMusicCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(musicCache));
//        for (int i = 1; i <= SpringUtils.MUSIC_COUNT; i++) {
//            SpringUtils.assertCacheValue(musicCache, keys.get(i - 1), EntitiesUtils.getMusic(i));
//        }
//    }
//
//    /**
...
//        final Music music = EntitiesUtils.newMusic(objectGenerator);
//
...
//        final Music music = EntitiesUtils.updateMusic(1, objectGenerator, entityManager);
//
...
//        final Music expectedMusic = EntitiesUtils.getMusic(3);
...
//        final Music expectedMusic1 = EntitiesUtils.getMusic(1);
//        expectedMusic1.setPosition(1);
//        final Music expectedMusic2 = EntitiesUtils.getMusic(2);
...
//
//        for (int i = 1; i <= SpringUtils.MUSIC_COUNT; i++) {
//            assertTrue(musicService.exists(EntitiesUtils.getMusic(i)));
//        }
//        DeepAsserts.assertEquals(SpringUtils.MUSIC_COUNT, SpringUtils.getMusicCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(musicCache));
//        for (int i = 1; i <= SpringUtils.MUSIC_COUNT; i++) {
...
//        DeepAsserts.assertEquals(SpringUtils.MUSIC_COUNT, SpringUtils.getMusicCount(entityManager));
//        DeepAsserts.assertEquals(keys, SpringUtils.getCacheKeys(musicCache));
//        SpringUtils.assertCacheValue(musicCache, keyList, EntitiesUtils.getMusic());
//        for (int i = 1; i <= count; i++) {
//            SpringUtils.assertCacheValue(musicCache, keyItems.get(i - 1), EntitiesUtils.getSongs(i));
//        }
//    }
//
//    /**
